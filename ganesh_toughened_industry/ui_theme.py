...
class ClaymorphismTheme:
    ...
    @staticmethod
    def create_date_entry(parent, date_var=None, width=12):
        """Create a date entry with claymorphism style"""
        ...
        date_entry = ClaymorphismTheme.create_entry(date_frame, textvariable=date_var, width=width)
        date_entry.pack(side=tk.LEFT)
        
        # Add calendar button
        from tkinter import font
        cal_btn = ttk.Button(date_frame, text="📅", width=3)
        cal_btn.pack(side=tk.LEFT, padx=(5, 0))
        
        return date_frame, date_entry
    
    @staticmethod
    def create_numeric_entry(parent, numeric_var=None, width=10):
        """Create a numeric entry with claymorphism style"""
        if numeric_var is None:
        ...
        entry = ttk.Entry(parent, textvariable=numeric_var, validate="key", validatecommand=vcmd)
