...
class VisitsModule:
    ...
    def create_ui(self):
        ...
        from_date_frame, from_date_entry = ClaymorphismTheme.create_date_entry(filter_frame, textvariable=self.from_date_var)
        ...
        to_date_frame, to_date_entry = ClaymorphismTheme.create_date_entry(filter_frame, textvariable=self.to_date_var)
    ...
    def add_visit(self):
        ...
        date_frame, date_entry = ClaymorphismTheme.create_date_entry(details_card, textvariable=date_var)
        date_frame.grid(row=4, column=1, padx=10, pady=10, sticky=tk.EW)
